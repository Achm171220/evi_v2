        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('berkas/tambah'); ?>" class="btn-right btn btn-sm btn-outline-primary">
                            Tambah Data
                        </a>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered p-0" id="berkasTable" style="width: 100%;">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>No Berkas</th>
                                ...
                                <th>Tahun Berkas</th>
                                <th width="15%">Jumlah Item Berkas</th>
                                <th>Manage Item</th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('berkas/importberkas') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <a href="https://www.bit.ly/formatDaftarEVI" class="btn btn-sm scc-btn mt-2" target="_blank">Template</a>
                    <button class="btn btn-sm btn-primary mt-2" type="submit">Upload</button>
                </form>
                <h2>Download Template Excel</h2>

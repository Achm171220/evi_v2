 <div class="row">
     <div class="col-md-12">
         ...
         <div class="card">
             ...
             <?= form_open('arsip/update/' . $dataId['id']); ?>
             <?= csrf_field() ?> <!-- Menambahkan token CSRF -->
             <div class="card-body">
                 <div class="form-group row">
                     <label class="col-form-label col-md-2">Unit Pencipta</label>
                     <div class="col-md-4">
                         <select class="js-example-basic-single select2" name="id_sub_bidang" style="width: 100%;">
                     ...
                     <div class="col-md-4">
                         <select class="js-example-basic-single select2" name="id_klasifikasi" style="width: 100%;">
